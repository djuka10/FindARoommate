...
-- Ads
-- slobodni oglasi
insert into ads (address, ad_type, available_from, available_until, boys_num, const_included, deposit, desc, flat_m2, ladies_num, latitude, longitude, max_days, max_person, min_days, price, room_m2, title, ad_status, owner_id) values
('Drage Spasic 7, Novi Sad, Serbia', 'type1', '2020-07-09', '2020-08-09', 3, 1, 300, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
 25, 2, 19.846840, 45.266144, '60', 5, '1-5 months', 240, 20, 'Apartment with positive view 1',0,1);
...
('Drage Spasic 7, Novi Sad, Serbia','type1', '2020-07-16', '2020-07-30', 3, 1, 300, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
 25, 2, 29.72224235534668, 48.2092170715332, '60', 5, '1-5 months', 322, 20, 'Apartment with positive view 2',2,1,2);
 
insert into ads (address, ad_type, available_from, available_until, boys_num, const_included, deposit, desc, flat_m2, ladies_num, latitude, longitude, max_days, max_person, min_days, price, room_m2, title, ad_status, owner_id, user_id) values
('Drage Spasic 7, Novi Sad, Serbia','type1', '2020-06-01', '2020-07-01', 3, 1, 300, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
 25, 2, 29.72224235534668, 48.2092170715332, '60', 5, '1-5 months', 322, 20, 'Apartment with positive view 3',2,1,2);
 
insert into reviews (rating, title, comment, ad_id, author_id, rated_user_id) values (4, 'Okay', 'It was okay', 1, 2, 4) ;
insert into reviews (rating, title, comment, ad_id, author_id, rated_user_id) values (3, 'Could be better', 'There are some things to improve', 1, 1, 2) ;
insert into reviews (rating, title, comment, ad_id, author_id, rated_user_id) values (5, 'Superb', 'I spend greet time here', 3, 4, 1) ;
...
insert into user_settings (DISTANCE,LANGUAGE,NEW_MESSAGE_NOTIF,NEW_REVIEW_NOTIF, REMIND_DAY, SHOULD_REMIND,STAY_NOTIF,SHOULD_REQUEST_MAIL,SHOULD_CONFIRM_MAIL,SHOULD_NEW_AD_MAIL,USER_ID  ) 
                       values ('km', 'english', true, true, '12', true, true, false, false, false, 2);
