...
import rs.ac.uns.ftn.findaroommate.task.BookTask;
...
public class BookService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i("BookService", "onStartCommand");
        ...
        if(status == AppTools.TYPE_NOT_CONNECTED){
            Log.e("BookService", "The connection is not established");
        }
        new BookTask(getApplicationContext()).execute(adId);
