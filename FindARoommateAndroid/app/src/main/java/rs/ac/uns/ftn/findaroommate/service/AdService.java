...
//
//import rs.ac.uns.ftn.findaroommate.task.AdTask;
...
//
//        Log.i("AdService", "onStartCommand");
...
//            Log.e("AdService", "The connection is not established");
//        }
//        new AdTask(getApplicationContext()).execute(adId);
//
//        stopSelf();
//
